      ...
      <div className="flex justify-between items-center">
        <div>
          ...
          <p className="text-stone-600 text-sm mt-1">
            Manage all business contacts and relationships
          </p>
        </div>
        <button 
                  ...
                  >
                    ...
                    <td className="px-6 py-4 text-sm">
                      <div className="flex gap-2">
                        ...
                        <button onClick={() => handleDeleteContact(contact.id)} className="p-1 hover:bg-stone-100 rounded transition-colors">
