          ...
          <tbody>
            {filteredDeals.map(deal => (
              <tr key={deal.id} className="border-b border-stone-200 hover:bg-stone-50">
                ...
                <td className="px-4 py-3 text-right text-stone-900 font-medium">{formatCurrency(deal.expectedValue)}</td>
                <td className="px-4 py-3 text-right text-stone-700">{deal.probability}%</td>
                <td className="px-4 py-3 text-right text-stone-900 font-medium">{formatCurrency(deal.weightedValue)}</td>
